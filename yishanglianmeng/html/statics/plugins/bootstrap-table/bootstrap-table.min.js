	...
	o.DEFAULTS = {
		...
		for (var f = this.pageFrom - 1; f < this.pageTo; f++) {
			...
			m._data && !a.isEmptyObject(m._data) && a.each(m._data, function(a, b) {
				...
				if (n = g('style="%s"', o.concat(c.header.styles[b]).join("; ")), l = k(c.header, c.header.formatters[b], [l, m, f], l), m["_" + e + "_id"] && (r = g(' id="%s"', m["_" + e + "_id"])), m["_" + e + "_class"] && (s = g(' class="%s"', m["_" + e + "_class"])), m["_" + e + "_rowspan"] && (u = g(' rowspan="%s"', m["_" + e + "_rowspan"])), q = k(c.header, c.header.cellStyles[b], [l, m, f], q), q.classes && (s = g(' class="%s"', q.classes)), q.css) {
					var w = [];
