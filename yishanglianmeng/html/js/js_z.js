$(function(){
	...
	$('#owl-demo img').css('margin-left','-'+w_banner+'px');
	
	$('.bd_m .kuan .li_m').click(function(){
		$(this).siblings('.lei_m').slideToggle();
		$('.bd_m .kuan .lei_m li').click(function(){
			var liz=$(this).html();
			$(this).parent('.lei_m').siblings('.li_m').children('span').html(liz);
			$(this).parent('.lei_m').slideUp();
		});
	});
	
	$('.quote_a li em').mousemove(function(){
		$(this).siblings('.des').show();
	});
	$('.quote_a li em').mouseleave(function(){
		$(this).siblings('.des').hide();
	});
	
	$('.i_mam li:nth-child(3n)').css('margin-right',0);
	$('.i_mdm li:nth-child(3n)').css('margin-right',0);
	$('.news dl:nth-child(2n)').css('margin-right',0);
	$('.foot .f_l ul li:nth-child(3n)').css('margin-right',0);
	$('.return ul li:nth-child(3n)').css('margin-right',0);
	$('.i_mcm li:nth-child(3n)').css('margin-right',40+'px');
	$('.i_mem dl:nth-child(2n)').children('dt').css('float','right');
	$('.i_mem dl:nth-child(2n)').children('dd').css('float','left');
	$('.order table tr:nth-child(2n)').css('background','#F9F9F9');
